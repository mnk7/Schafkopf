...
public class Server extends Thread {
        ...
        public Server(String configdir) {
        	this(PORT, 10, 2000, configdir);
        }
                
        /**
         * Erstellt einen neuen Server
         **/
        public Server(int port, int tarif, int wartezeit, String configdir) {
        	super();
        ...
        /**
         * Nimmt neue Verbindungen an, bis der Server voll ist
         */
        public void run() {
        	try {
        		while(!beenden) {
        ...
        /**
         * Startet ein Spiel mit den Anwesenden Spielern
         * @param spielerzahl
         * @throws Exception 
         */
